...
The school code is usually some part of the name of the school, or an abbreviation of it.
...
* `externalLoginsOnly`
    * Whether the only available login methods are those listed in `externalLogins` or not.
* `logo`
